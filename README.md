...
See the autogenerated CLI docs generated from Cobra:

- [`docs/envtab.md`](docs/envtab.md): top-level `envtab` usage and flags
- `docs/envtab_*.md`: per-command reference (e.g., `docs/envtab_import.md`, `docs/envtab_cat.md`)

You can regenerate these docs at any time with:
